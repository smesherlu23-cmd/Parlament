...
#: Какое разрешение выбрано в диалоге по умолчанию — индекс в `RESOLUTIONS`.
#: 4K, а не Full HD: выгружают обычно один раз и печатают или показывают на
#: весь экран, а уменьшить с запасом всегда можно, увеличить — нет.
DEFAULT_RESOLUTION_INDEX = len(RESOLUTIONS) - 1
