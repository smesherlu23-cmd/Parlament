...
- **Поддержка** — у каждого населённого пункта шесть очков неформальной
  ...
  на этом же экране — в карте их нет. Заполнять по одному полю не обязательно:
...
211 тестов: бизнес-логика (валидация мест, справочник, созывы, удаление созыва,
...
parlament/
  ...
  votes_import.py           разбор таблиц: поддержка по НП и голоса
  ...
  ui/
    ...
    votes_file.py           чтение таблицы с диска и выгрузка шаблона
