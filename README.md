...
- **Экспорт в PNG** — схема зала и карта округов, в 1920×1080, 2560×1440
  ...
  тот же диалог экспорта, вызывается кнопкой на своём экране.
...
311 тестов: бизнес-логика (валидация мест, справочник, созывы, удаление созыва,
выборы по округам, доли и модификаторы, поддержка в НП и городах, разбор таблицы
