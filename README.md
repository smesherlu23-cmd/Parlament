...
`Parlament-windows.zip` — распаковать и запустить exe внутри. Обычный zip,
а не самораспаковывающийся exe: такие exe (тихо распаковывает и запускает
другой exe из временной папки) антивирусы массово принимают за троян-
дроппер по поведению, даже без единой вредоносной строчки внутри.
