...
- **Поддержка** — у населённого пункта шесть очков неформальной
  популярности, которые делятся между партиями; у городского округа их
  вдвое больше — двенадцать, потому что город сам себе населённый пункт и
  людей в нём больше. Из очков считается модификатор: сумма очков партии в
  округе, делённая на число пунктов. Все 44 пункта заведены сразу по карте —
  вбивать их руками не нужно; можно добавить свой хутор, а название правится
  щелчком по нему. Заполнять по одному полю не обязательно:
...
262 теста: бизнес-логика (валидация мест, справочник, созывы, удаление созыва,
