...
- **Справочник партий** — название и цвет: палитра на 16 готовых оттенков,
  ...
  похожих партий. Правки расходятся по всем созывам, где партия участвует.
...
102 теста: бизнес-логика (валидация мест, справочник, созывы, удаление созыва,
файл проекта), геометрия схемы, экспорт PNG и сам интерфейс — экраны и диалоги прогоняются
