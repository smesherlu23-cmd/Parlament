...
- **Справочник партий** — название и цвет: палитра на 16 готовых оттенков,
  ввод HEX или свой цвет через тон/насыщенность/светлоту. Правки расходятся
  по всем созывам, где партия участвует.
...
85 тестов: бизнес-логика (валидация мест, справочник, созывы, файл проекта),
