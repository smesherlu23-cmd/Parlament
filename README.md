...
- **Выборы по округам** — 27 округов игровой карты на 124 мандата. Голоса не
  ...
  очков поддержки, розданных там игроками (поровну, если очков вообще не
  роздано — организации нет ни у кого, а не у кого-то одного). К базе (в
  процентных пунктах) прибавляются три поправки — местный модификатор на
...
- **Карта** — округа нарисованы своими границами и красятся в цвет
  победившей партии. Клик по округу показывает разбор: база, модификаторы
  (местный, по острову, по стране), колебание, итоговый процент и места.
...
355 тестов: бизнес-логика (валидация мест, справочник, созывы, удаление созыва,
выборы по округам, доли и модификаторы, коалиции и плёнка на схеме, поддержка в
НП и городах, разбор таблицы поддержки, свои цвета, файл проекта),
